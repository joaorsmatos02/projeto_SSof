...
class BinOp:
    ...
    def eval(self, policy, multilabelling, vulnerabilities, multilabellingMaster):
        ...
        left_result = self.left.eval(policy, multilabelling, vulnerabilities, multilabellingMaster)
        ...
        right_result = self.right.eval(policy, multilabelling, vulnerabilities, multilabellingMaster)
